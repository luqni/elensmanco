...
$pdf->Image('../../style/assets/img/logo smanco.png',15,18,16);
$pdf->SetTitle("Cetak Data");
$pdf->SetFont('Arial','B',18);
$pdf->Cell(0,5,'SMA N 1 Comal','0','1','C',false);
$pdf->SetFont('Arial','i',8);
$pdf->Cell(0,5,'Alamat : Jln. A. Yami No. 77, Purwoharjo, Comal, Pemalang','0','1','C',false);
...
$pdf->Cell(0,0,"Comal, ".tgl_indo(date('Y-m-d')),0,0,'L');
